...
export default function AlerteQualitePage() {
  ...
  // 1) charger la liste des FE (léger: juste id + numero_fe)
  useEffect(() => {
  ...
  // 3) quand on choisit une FE -> charger détail
...
const openXlsx = () => {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      {/* aperçu (pour vérifier que la FE est bien chargée) */}
      <div style={{ marginTop: 16, border: "1px solid #e5e7eb", borderRadius: 12, padding: 14, background: "white" }}>
        {!selectedId ? (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "160px 1fr", gap: 10 }}>
            ...
            <div style={{ fontWeight: 700 }}>Date</div><div>{selectedFe?.date_creation || "—"}</div>
