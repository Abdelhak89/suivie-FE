// src/pages/ClientPage.jsx - Page Client (RCLI)
    ...
    const loadData = async () => {
      ...
      try {
        const result = await getAllFE({
          q: q.trim() || null,
          statut: statut || null,
          origine: "RCLI", // ✅ Réclamation Client
          annee: annee || null,
          limit: pageSize,
        ...
        if (!ctrl.signal.aborted) {
          console.error("Erreur chargement FE Clients:", error);
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
        <div>
          ...
          <div style={{ color: "#666", marginTop: 4 }}>
            {loading ? "Chargement..." : `${total} réclamations clients trouvées`}
          </div>
        </div>
        <span style={{
          padding: "6px 12px",
        ...
        <table style={{ 
          ...
          <thead>
            <tr style={{ background: "#f9fafb", borderBottom: "2px solid #e5e7eb" }}>
              ...
              <th style={{ padding: "12px 16px", textAlign: "left", fontWeight: 700 }}>Client</th>
          ...
          <tbody>
            {items.map((fe, idx) => (
              ...
              >
                ...
                <td style={{ padding: "12px 16px" }}>{fe.client_fourn || "—"}</td>
            ...
            {!items.length && !loading && (
              <tr>
                ...
                >
                  Aucune réclamation client trouvée
                </td>
              </tr>
            )}
          </tbody>
