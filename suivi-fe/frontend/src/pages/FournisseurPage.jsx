// src/pages/FournisseurPage.jsx - Page Fournisseur (DFOU)
    ...
    const loadData = async () => {
      ...
      try {
        const result = await getAllFE({
          q: q.trim() || null,
          statut: statut || null,
          origine: "DFOU", // ✅ Défaut Fournisseur
          annee: annee || null,
          limit: pageSize,
        ...
        if (!ctrl.signal.aborted) {
          console.error("Erreur chargement FE Fournisseurs:", error);
  ...
  return (
    <div style={{ padding: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
        <div>
          <h2 style={{ margin: 0 }}>Fournisseur</h2>
          <div style={{ color: "#666", marginTop: 4 }}>
            {loading ? "Chargement..." : `${total} FE fournisseurs trouvées`}
          </div>
        </div>
        <span style={{
          padding: "6px 12px",
        ...
        <table style={{ 
          ...
          <thead>
            <tr style={{ background: "#f9fafb", borderBottom: "2px solid #e5e7eb" }}>
              ...
              <th style={{ padding: "12px 16px", textAlign: "left", fontWeight: 700 }}>Fournisseur</th>
          ...
          <tbody>
            {items.map((fe, idx) => (
              ...
              >
                ...
                <td style={{ padding: "12px 16px" }}>{fe.fournisseur_resp || "—"}</td>
